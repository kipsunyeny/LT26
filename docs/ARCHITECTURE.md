...
`public/manifest.webmanifest`, `public/icons/*` (generated by `npm run assets`), `public/sw.js` (precache of the whole build, generated at build time by `scripts/build-sw.mjs` from `dist/` so hashed filenames are included), `.github/workflows/pages.yml`, README, CHANGELOG, TESTING.
